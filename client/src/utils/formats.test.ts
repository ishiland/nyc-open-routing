...
describe("formatDistance", () => {
  ...
  it("should format distances in miles when greater than 1000 feet", () => {
    ...
    expect(formatDistance(10560)).toBe("2.0 mi")
...
describe("formatTotalRouteDistance", () => {
  it("should correctly sum and format the total distance", () => {
    ...
    expect(formatTotalRouteDistance(routes)).toBe("0.6 mi")

    const longRoutes = [
      { properties: { travel_time: 15, distance: 2640 } },
      { properties: { travel_time: 10, distance: 2640 } },
    ]
