...
interface Suggestion extends AddressProperties { }
...
export function renderSuggestion(suggestion: AddressProperties, { query, isHighlighted }: RenderSuggestionParams) {
    ...
    return (
        <MenuItem selected={isHighlighted} component="div" sx={{ fontSize: '14px' }}>
            <Box component="div">
